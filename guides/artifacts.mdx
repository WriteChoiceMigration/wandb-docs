...
2. Create an artifact object with the [`wandb.Artifact`](/ref/python/sdk/classes/artifact) API.
...
Indicate the artifact you want to mark as input to your run with the [`use_artifact`](/ref/python/sdk/classes/run.md#use_artifact) method.
...
<Note>
You can pass a custom path into the `root` [parameter](/ref/python/sdk/classes/artifact) to download an artifact to a specific directory. For alternate ways to download artifacts and to see additional parameters, see the guide on [downloading and using artifacts](./download-and-use-an-artifact).
</Note>
...
* Explore the [Python SDK](/ref/python/sdk/classes/artifact) and [CLI](/ref/cli/wandb-artifact/) reference guides.
