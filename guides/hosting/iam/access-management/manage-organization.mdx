...
By default, only a team or instance admin can invite members to a team. To change this behavior, refer to [Team settings](/guides/models/app/settings-page/team-settings#privacy).
