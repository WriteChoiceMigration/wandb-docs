...
<Note>
Your [role in a team](/guides/models/app/settings-page/teams.md#team-role-and-permissions) has no impact or relationship to your role in any registry.
</Note>
...
- [`Run.use_artifact()`](/ref/python/sdk/classes/run/#method-runuse_artifact)
- [`Artifact.download()`](/ref/python/sdk/classes/artifact/#method-artifactdownload)
- [`Artifact.file()`](/ref/python/sdk/classes/artifact/#method-artifactfile)
- [`Artifact.files()`](/ref/python/sdk/classes/artifact/#method-artifactfiles)

The following methods are limited to artifact metadata:
- [`Artifact.get_entry()`](/ref/python/sdk/classes/artifact/#method-artifactget_entry)
- [`Artifact.get_path()`](/ref/python/sdk/classes/artifact/#method-artifactget_path)
- [`Artifact.get()`](/ref/python/sdk/classes/artifact/#method-artifactget)
- [`Artifact.verify()`](/ref/python/sdk/classes/artifact/#method-artifactverify)
