...
See [`use_artifact`](/ref/python/sdk/classes/run.md#use_artifact) and [`Artifact.download()`](/ref/python/sdk/classes/artifact.md#download) in the API Reference for parameters and return type.
