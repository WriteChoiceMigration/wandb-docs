...
See [`use_artifact`](/ref/python/sdk/classes/run#use_artifact) and [`Artifact.download()`](/ref/python/sdk/classes/artifact#download) in the API Reference for parameters and return type.
