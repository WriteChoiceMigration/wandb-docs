...
See [`use_model`](/ref/python/sdk/classes/run#use_model) in the API Reference guide for more information on possible parameters and return type.
...
See [`use_model`](/ref/python/sdk/classes/run#use_model) in the API Reference guide for parameters and return type.
</Tab>
<Tab title="W&B App">
