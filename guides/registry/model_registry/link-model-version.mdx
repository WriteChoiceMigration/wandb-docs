...
Use the [`link_model`](/ref/python/sdk/classes/run#link_model) method to programmatically log model files to a W&B run and link it to the [W&B Model Registry](./). 
