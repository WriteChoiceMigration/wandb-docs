...
2. Second, use the run objects [`use_artifact()`](/ref/python/sdk/classes/run#use_artifact) method to tell W&B what artifact to use. This returns an artifact object.
3. Third, use the artifacts [`download()`](/ref/python/sdk/classes/artifact#download) method to download the contents of the artifact.
