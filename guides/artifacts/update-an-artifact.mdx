...
Use the W&B Public API ([`wandb.Api`](/ref/python/public-api/api)) to update an artifact outside of a run. Use the Artifact API ([`wandb.Artifact`](/ref/python/sdk/classes/artifact)) to update an artifact during a run.
...
The proceeding code example demonstrates how to update the description of an artifact using the [`wandb.Artifact`](/ref/python/sdk/classes/artifact) API:
...
For more information, see the Weights and Biases [Artifact API](/ref/python/sdk/classes/artifact).  
  {{% /tab %}}
