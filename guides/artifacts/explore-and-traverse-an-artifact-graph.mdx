...
Use the artifact object's [`logged_by`](/ref/python/sdk/classes/artifact.md#logged_by) and [`used_by`](/ref/python/sdk/classes/artifact.md#used_by) methods to walk the graph from the artifact:
