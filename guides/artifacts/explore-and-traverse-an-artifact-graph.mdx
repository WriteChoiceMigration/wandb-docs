...
Use the artifact object's [`logged_by`](/ref/python/sdk/classes/artifact#logged_by) and [`used_by`](/ref/python/sdk/classes/artifact#used_by) methods to walk the graph from the artifact:
