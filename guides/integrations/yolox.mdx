...
Use the `--logger wandb` command line argument to turn on logging with wandb. Optionally you can also pass all of the arguments that [`wandb.init()`](/ref/python/sdk/functions/init) expects; prepend each argument with `wandb-`.
