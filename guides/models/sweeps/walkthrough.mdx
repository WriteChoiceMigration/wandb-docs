...
Optionally provide the name of the project where you want the output of the W&B Run to be stored (project parameter in [`wandb.init()`](/ref/python/sdk/functions/init)). If the project is not specified, the run is put in an "Uncategorized" project.
...
Use the [`wandb.agent()`](/ref/python/sdk/functions/agent) API call to start a sweep.
