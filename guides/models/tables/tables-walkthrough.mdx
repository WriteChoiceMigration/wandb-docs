...
- [`wandb.init()`](/ref/python/sdk/functions/init): Create a [run](/guides/models/track/runs/) to track results.
- [`wandb.Table()`](/ref/python/sdk/data-types/table): Create a new table object.
  - `columns`: Set the column names.
  - `data`: Set the contents of each row.
- [`wandb.Run.log()`](/ref/python/sdk/classes/run.md/#method-runlog): Log the table to save it to W&B.
...
For more information on supported data types, see the [`wandb.Table`](/ref/python/sdk/data-types/table) in the W&B API Reference Guide.
</Tab>
</Tabs>
