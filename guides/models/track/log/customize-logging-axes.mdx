...
In certain situations, it makes more sense to log metrics against a different x-axis such as a logarithmic x-axis. Use the [`define_metric()`](/ref/python/sdk/classes/run/#define_metric) method to use any metric you log  as a custom x-axis.
