...
Group runs in a run set programmatically with the [Workspace and Reports API](/ref/python/wandb_workspaces/reports).
...
Programmatically filter run sets and add them to a report with the [Workspace and Reports API](/ref/python/wandb_workspaces/reports).
