...
- To create a registry automation, you must have access to the registry. Refer to [Configure Registry access](/guides/core/registry/configure_registry#registry-roles).
...
Or, from a line plot in the workspace, you can quickly create a [run metric automation](/guides/core/automations/automation-events#run-events) for the metric it shows:
