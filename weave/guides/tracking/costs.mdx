...
<Tabs>
  <Tab title="Python">
    You can add a custom cost by using the [`add_cost`](/reference/python-sdk/weave/trace/weave_client#add_cost) method.
...
<Tabs>
  <Tab title="Python">
    You can query for costs by using the [`query_costs`](/reference/python-sdk/weave/trace/weave_client#query_costs) method.
...
<Tabs>
  <Tab title="Python">
    You can purge a custom cost by using the [`purge_costs`](/reference/python-sdk/weave/trace/weave_client#purge_costs) method. You pass in a list of cost ids, and the costs with those ids are purged.
