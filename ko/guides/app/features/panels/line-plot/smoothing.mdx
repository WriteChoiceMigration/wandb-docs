...
- [지수 이동 평균](/ko/smoothing.md#exponential-moving-average-default) (기본값)
- [가우시안 평활화](/ko/smoothing.md#gaussian-smoothing)
- [이동 평균](/ko/smoothing.md#running-average)
- [지수 이동 평균 - Tensorboard](/ko/smoothing.md#exponential-moving-average-deprecated) (더 이상 사용되지 않음)
