...
가능한 파라미터 및 반환 유형에 대한 자세한 내용은 API Reference 가이드의 [`use_artifact`](/ko/ref/python/run.md#use_artifact) 및 [`Artifact.download()`](/ko/ref/python/artifact#download)를 참조하십시오.
