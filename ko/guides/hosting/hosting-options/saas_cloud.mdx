...
* 조직 범위 내에서 그리고 팀 내에서 [적절한 user 역할을 구성합니다](/ko/guides/hosting/iam/access-management/manage-organization.md#assign-or-update-a-users-role).
