...
[참조 아키텍처](/ko/../ref-arch.md#infrastructure-requirements)를 참조하세요. 또한 [유효한 W&B Server 라이선스를 획득하세요](/ko/../#obtain-your-wb-server-license).
...
마이그레이션 프로세스에 대한 자세한 설명은 [여기](/ko/../install-on-public-cloud/aws-tf.md#migrate-to-operator-based-aws-terraform-modules)를 계속 진행하세요.
